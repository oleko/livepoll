    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-white">LivePoll AI</h1>
          <p className="mt-1 text-sm text-slate-400">Войдите в свой аккаунт</p>
        </div>

        <Suspense fallback={<div className="rounded-xl border border-slate-800 bg-slate-900 p-6 h-64 animate-pulse" />}>
          <LoginForm />
        </Suspense>
