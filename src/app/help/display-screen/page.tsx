  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="space-y-8">
        ...
        <section>
          <h2 className="text-base font-semibold text-slate-900 dark:text-white mb-4">Три режима экрана</h2>
          <div className="space-y-3">
            <Mode
              label="Ожидание"
              desc="Когда ни один опрос не запущен. На экране — крупный QR-код и код для ручного ввода. Участники могут подключиться и ждать первого голосования."
            />
            <Mode
              label="Активный опрос"
              desc="Когда опрос запущен. На экране — вопрос и живые результаты, которые обновляются по мере поступления голосов. Показывается тип опроса, количество проголосовавших и, если задан таймер, обратный отсчёт."
            />
            <Mode
              label="Вопрос из зала (Q&A)"
              desc="Когда ведущий выносит вопрос на экран. Выбранный вопрос отображается крупно — аудитория видит, что именно сейчас обсуждается."
            />
          </div>
        </section>
        ...
        <section>
          ...
          <ul className="space-y-2.5">
            {[
              ...
              "Тёмный фон экрана хорошо смотрится на большинстве проекторов. Не меняйте яркость монитора перед выступлением.",
