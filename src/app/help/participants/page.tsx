...
export const metadata = { title: "Для участников" };
...
export default function ParticipantsPage() {
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Для участников</h1>
      <p className="text-slate-500 dark:text-slate-400 mb-10">
        Как подключиться к голосованию — без регистрации и без приложений.
      </p>
