...
const SCREENS = [
  ...
  },
  {
    icon: "🎡",
    name: "Колесо фортуны",
    when: "Случайный выбор победителя розыгрыша или следующего докладчика. Анимация слот-машины разворачивается на весь экран и останавливается на случайном варианте.",
    fields: ["Заголовок (необязательно)", "Список вариантов (каждый с новой строки)"],
    example: "Список участников конкурса: Анна, Иван, Мария, Пётр → крутим → победитель",
  },
  {
    icon: "📣",
    name: "Объявление",
