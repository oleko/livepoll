  ...
  return (
    <div className="max-w-prose">
      ...
      <p className="text-slate-500 dark:text-slate-400 mb-10">
        Управляйте тем, что видит аудитория на проекторе — не только результаты опросов, но и заставки, карточки спикеров, расписание и финальный экран.
      </p>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ol className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
            ...
            <li className="flex gap-3">
              ...
              Выберите тип из пяти вариантов.
            </li>
            <li className="flex gap-3">
        ...
        <section>
          <h2 className="text-base font-semibold text-slate-900 dark:text-white mb-4">Пять типов экранов</h2>
        ...
        <section>
          ...
          <div className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
            {[
              ...
              { icon: "📊", text: "Во время доклада — запустите опрос. Живые результаты прямо в теме." },
