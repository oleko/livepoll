    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            На странице участника появляется вкладка Q&A. Там есть поле ввода — участник
            пишет вопрос и нажимает «Отправить». Вопрос сразу появляется в панели ведущего.
          </p>
        ...
        <section>
          <h2 className="text-base font-semibold text-slate-900 dark:text-white mb-3">Голосование за вопросы</h2>
          <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            Участник видит все вопросы и может нажать <b>▲</b> под любым, поддерживая его.
            Каждый участник может проголосовать за один вопрос только один раз.
            В панели ведущего вопросы сортируются по числу голосов — самые важные
            для аудитории всплывают наверх.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
            ...
            что видит зал. Для каждого вопроса доступны три действия:
          </p>
          <div className="space-y-3">
            <Action
              label="Вынести на экран"
              icon="📺"
              desc="Выбранный вопрос появится на дисплейном экране крупно. Можно показывать по одному вопросу — предыдущий убирается."
            />
            <Action
            ...
            <Action
              label="Скрыть"
              icon="🚫"
              desc="Вопрос исчезает из списка участников и не отображается на экране. Используйте для нерелевантных или неуместных вопросов."
            />
          </div>
        </section>
