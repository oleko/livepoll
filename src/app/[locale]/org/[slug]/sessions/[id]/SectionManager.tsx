...
import { createSection, deleteSection, renameSection } from "@/lib/actions/sections";
              ...
              {editingId === s.id ? (
                <>
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className="text-xs text-indigo-600 dark:text-indigo-400 hover:underline disabled:opacity-50 shrink-0"
                  >
                    ✓
                  </button>
                  <button
