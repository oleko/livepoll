...
const TYPES = [
  ...
  },
  {
    ...
    how: "Участник выбирает значение от 1 до 5 через эмодзи-шкалу (❄️→🔥). На экране отображается количество ответов по каждой позиции.",
  ...
  },
  {
    ...
    how: "Участники выбирают карту с оценкой (1, 2, 3, 5, 8, 13, 21, ?, ☕). Результаты скрыты до нажатия «🃏 Раскрыть» ведущим, затем показывается гистограмма выборов.",
  ...
  },
  {
    ...
    settings: ["Нет таймера: идеи принимаются весь сеанс", "Неограниченное число идей от участника", "Ведущий может скрыть неподходящие", "AI-анализ в панели идей"],
  },
];
