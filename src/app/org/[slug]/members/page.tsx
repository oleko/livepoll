...
export default async function MembersPage({
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-white">Команда</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <div className="rounded-xl border border-slate-800 bg-slate-900 overflow-hidden">
            {members?.map((m) => {
              ...
              return (
                <div key={m.id} className="flex items-center justify-between px-5 py-4 border-b border-slate-800 last:border-0">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      {m.accepted_at ? (
                        ...
                        <span className="text-amber-500">Приглашение отправлено</span>
                      )}
                    </p>
                  </div>
                  {m.user_id !== user.id && (
        ...
        <div>
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-5">
            <h2 className="text-sm font-semibold text-white mb-4">Пригласить участника</h2>
