...
import { Dialog, DialogRawContent, DialogClose } from "@/components/ui/Dialog";
...
export function OnboardingTour() {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) dismiss(); }}>
      <DialogRawContent>
        <div className="relative w-full max-w-sm rounded-2xl bg-white dark:bg-slate-900 shadow-2xl p-8 flex flex-col items-center text-center">
          <DialogClose
            onClick={dismiss}
